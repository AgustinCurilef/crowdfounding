...
<body class="register-page background-impulsa">
        ...
        <div class="card card-outline card-personalized">
            <div class="card-header">
                <a href="<?= base_url('/') ?>" class="link-dark text-center link-offset-2 link-opacity-100 link-opacity-50-hover">
                    <h1 class="mb-0"> <img src="<?= base_url('/template/dist/assets/img/LogoImpulsa.png') ?>" alt="Logo" class="brand-image opacity-100" style="max-width: 150px;">
                    </h1>
                </a>
            </div> <!-- /.register-logo -->
            <div class="card">
