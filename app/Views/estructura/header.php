...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url('template/dist/css/investment'); ?>">
    ...
    <link rel="stylesheet" href="<?php echo base_url('template/dist/css/adminlte.css'); ?>"><!--end::Required Plugin(AdminLTE)--><!-- apexcharts -->
    ...
    <link rel="stylesheet" href="<?php echo base_url('template/dist/css/scoreEntrepreneur.css'); ?>">
